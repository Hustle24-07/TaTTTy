...
export const COUPLES_PAGE_UI_TEXT = {
  title: "Couples Tattoos",
  description: "Design matching tattoos that celebrate your bond",
} as const;
...
export const INK_REDEMPTION_UI_TEXT = {
  ...
  description: "Transform your existing tattoos into something new",
} as const;
...
export const FONTS_UI_TEXT = {
  title: "Tattoo Fonts",
  description: "Find the perfect typography for your next tattoo",
} as const;
